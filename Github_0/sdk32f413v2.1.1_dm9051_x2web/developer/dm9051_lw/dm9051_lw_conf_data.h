...
const spi_dev_t devconf[BOARD_SPI_COUNT] = {
	...
	#define devconf_at437_spi4(info, spi_setting_name, cs_setting_name) \
		{ \
			info, \
			{"SPI4", SPI4, CRM_SPI4_PERIPH_CLOCK, IO_MUX_NULL}, \
			spi_setting_name, \
	...
	#define devconf_at413_spi1_0(info, spi_setting_name, cs_setting_name, gp_port, gp_pin, gp_crm_clk) \
		{ \
			...
			{GPIOB,		GPIO_PINS_4, 	CRM_GPIOB_PERIPH_CLOCK, 	GPIO_MODE_INPUT,	GPIO_PINSRC_NULL, GPIO_MUX_NULL}, /* //IMISO */ \
			{GPIOB,		GPIO_PINS_5, 	CRM_GPIOB_PERIPH_CLOCK, 	GPIO_MODE_MUX,		GPIO_PINSRC_NULL, GPIO_MUX_NULL}, /* //IMOSI */ \
			\
			cs_setting_name, \
			{gp_port,	gp_pin, 		gp_crm_clk, 				GPIO_MODE_OUTPUT, GPIO_PINSRC_NULL, GPIO_MUX_NULL}, /* //(PA4) Test-ISP2 OK */ \
			/* {GPIOB,	GPIO_PINS_12,	CRM_GPIOB_PERIPH_CLOCK, 	GPIO_MODE_OUTPUT, GPIO_PINSRC_NULL, GPIO_MUX_NULL}, //(PB12) Test-ISP2 OK */ \
			/* {GPIOA,	GPIO_PINS_4,	CRM_GPIOA_PERIPH_CLOCK, 	GPIO_MODE_OUTPUT, GPIO_PINSRC_NULL, GPIO_MUX_NULL}, (PA4) Test-ISP2 OK */ \
		}

	//AT32F413/415
	#define SPI_PINSEL_STD(spiname,spinum,crm_clk,iom)	{spiname,spinum,crm_clk, iom}
	#define GPIO_PINSEL_NORM(gpport,pin,crm_clk)		{gpport,pin,crm_clk, GPIO_MODE_MUX, GPIO_PINSRC_NULL, GPIO_MUX_NULL}
	#define GPIO_PINSEL_INPUT(gpport,pin,crm_clk)		{gpport,pin,crm_clk, GPIO_MODE_INPUT, GPIO_PINSRC_NULL, GPIO_MUX_NULL}
	#define GPIO_PINSEL_OUTPUT(gpport,pin,crm_clk)		{gpport,pin,crm_clk, GPIO_MODE_OUTPUT, GPIO_PINSRC_NULL, GPIO_MUX_NULL}
		
	#define devconf_at413_spi2(info, spi_setting_name, cs_setting_name) { \
			info, \
			SPI_PINSEL_STD("SPI2", SPI2, CRM_SPI2_PERIPH_CLOCK, IO_MUX_NULL), \
			spi_setting_name, \
			GPIO_PINSEL_NORM(GPIOB,		GPIO_PINS_13,	CRM_GPIOB_PERIPH_CLOCK),  /* //ISCK */ \
			GPIO_PINSEL_NORM(GPIOB,		GPIO_PINS_14,	CRM_GPIOB_PERIPH_CLOCK),	/* //IMISO */ \
			GPIO_PINSEL_NORM(GPIOB,		GPIO_PINS_15,	CRM_GPIOB_PERIPH_CLOCK),	/* //IMOSI */ \
			cs_setting_name, \
			GPIO_PINSEL_OUTPUT(GPIOB,	GPIO_PINS_12,	CRM_GPIOB_PERIPH_CLOCK), /* //(PB12) */ \
		}
	#define devconf_at413_spi1a(info, spi_setting_name, cs_setting_name, gp_port, gp_pin, gp_crm_clk, iom) { \
			info, \
			SPI_PINSEL_STD("SPI1", SPI1, CRM_SPI1_PERIPH_CLOCK, iom), \
			spi_setting_name, \
			GPIO_PINSEL_NORM(GPIOA,		GPIO_PINS_5,	CRM_GPIOA_PERIPH_CLOCK),  /* //ISCK */ \
			GPIO_PINSEL_INPUT(GPIOA,	GPIO_PINS_6,	CRM_GPIOA_PERIPH_CLOCK), /* //IMISO */ \
			GPIO_PINSEL_NORM(GPIOA,		GPIO_PINS_7,	CRM_GPIOA_PERIPH_CLOCK), /* //IMOSI */ \
			cs_setting_name, \
			GPIO_PINSEL_OUTPUT(gp_port,	gp_pin,			gp_crm_clk), /* //(PA4) */ \
		}
	#define devconf_at413_spi1b(info, spi_setting_name, cs_setting_name, gp_port, gp_pin, gp_crm_clk, iom) { \
			info, \
			SPI_PINSEL_STD("SPI1", SPI1, CRM_SPI1_PERIPH_CLOCK, iom), \
			spi_setting_name, \
			GPIO_PINSEL_NORM(GPIOB,		GPIO_PINS_3,	CRM_GPIOB_PERIPH_CLOCK),  /* //ISCK */ \
			GPIO_PINSEL_INPUT(GPIOB,	GPIO_PINS_4,	CRM_GPIOB_PERIPH_CLOCK), /* //IMISO */ \
			GPIO_PINSEL_NORM(GPIOB,		GPIO_PINS_5,	CRM_GPIOB_PERIPH_CLOCK), /* //IMOSI */ \
			cs_setting_name, \
			GPIO_PINSEL_OUTPUT(gp_port,	gp_pin,			gp_crm_clk), /* //(PA4) */ \
		}
...
DECL_SG_FUNCTION(enable_t, test_plan_log)
