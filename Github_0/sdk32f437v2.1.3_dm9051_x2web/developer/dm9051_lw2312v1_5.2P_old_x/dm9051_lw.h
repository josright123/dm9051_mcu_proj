...
#define chipid_on_pin_code_log_s(str, fstr, id)		printf("...%s...          %s Read Chip ID OK: %02x\r\n", fstr, str, id)
#define chipid_on_pin_code_log_err(str, fstr, id)	printf("...%s...          %s Read Chip ID error: %02x\r\n", fstr, str, id)
