...
#define DECLARATION_LOCAL_IPADDR \
uint8_t cfg_local_ipe[ETHERNET_COUNT][ADDR_LENGTH]   	= { {192, 168, 6, 6}, {192, 168, 6, 7}, \
}; \
uint8_t cfg_local_gwe[ETHERNET_COUNT][ADDR_LENGTH]   	= { {192, 168, 6, 1}, {192, 168, 6, 1}, \
}; \
uint8_t cfg_local_maske[ETHERNET_COUNT][ADDR_LENGTH] 	= { {255, 255, 255, 0}, {255, 255, 255, 0}, \
}
#endif

//uint8_t cfg_local_ipe[ADDR_LENGTH]   				= {192, 168, 1, IP_3RD}; \
//uint8_t cfg_local_gwe[ADDR_LENGTH]   				= {192, 168, 1, 254}; \
//uint8_t cfg_local_maske[ADDR_LENGTH] 				= {255, 255, 255, 0}
#endif
